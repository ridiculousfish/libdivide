...
static LIBDIVIDE_INLINE uint8_t libdivide_count_leading_zeros16(uint16_t val) {
#if defined(__AVR__)
    ...
    return 0;
#else
    return libdivide_count_leading_zeros16_software(val);
#endif
}
...
static LIBDIVIDE_INLINE uint8_t libdivide_count_leading_zeros32(uint32_t val) {
#if defined(__AVR__)
    // Fast way to count leading zeros
    return (uint8_t)__builtin_clzl(val);
#elif defined(__GNUC__) || __has_builtin(__builtin_clz)
    // Fast way to count leading zeros
    ...
    return 0;
#else
    return libdivide_count_leading_zeros32_software(val);
#endif
}
...
static LIBDIVIDE_INLINE uint8_t libdivide_count_leading_zeros64(uint64_t val) {
    ...
    return 32U + libdivide_count_leading_zeros32(lo);
#endif
}
...
static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_32_div_16_result_t libdivide_32_div_16_to_16(
...
static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE bool libdivide_internal_u16_ispow2(uint16_t d) {
    return (d & (d - 1)) == 0;
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE uint8_t libdivide_internal_u16_floor_log_2_d(uint8_t leading_zeroes) {
    return (uint8_t)15U - leading_zeroes;
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_u16_t libdivide_internal_u16_gen_gen(
    uint16_t d, bool branchfree, uint8_t floor_log_2_d, struct libdivide_32_div_16_result_t proposed_m) {
    // Power of 2
    if (libdivide_internal_u16_ispow2(d)) {
        // We need to subtract 1 from the shift value in case of an unsigned
        // branchfree divider because there is a hardcoded right shift by 1
        // in its division algorithm. Because of this we also need to add back
        // 1 in its recovery algorithm.
        return libdivide_internal_construct_u16(0U, (uint8_t)(floor_log_2_d - (branchfree ? 1U : 0U)));
    } else {
        ...
        return libdivide_internal_construct_u16(1U + proposed_m.quot, more);
...
static LIBDIVIDE_INLINE struct libdivide_u16_t libdivide_internal_u16_gen(
    ...
    uint8_t floor_log_2_d = libdivide_internal_u16_floor_log_2_d(libdivide_count_leading_zeros16(d));
    struct libdivide_32_div_16_result_t null_proposed_m = { 0U, 0U };
    struct libdivide_32_div_16_result_t proposed_m = libdivide_internal_u16_ispow2(d) ? null_proposed_m : libdivide_32_div_16_to_16((uint16_t)1 << floor_log_2_d, 0, d);
    return libdivide_internal_u16_gen_gen(d, branchfree, floor_log_2_d, proposed_m);
}
...
struct libdivide_u16_branchfree_t libdivide_u16_branchfree_gen(uint16_t d) {
    ...
    return libdivide_internal_construct_u16_branchfree(tmp.magic, (uint8_t)(tmp.more & LIBDIVIDE_16_SHIFT_MASK));
}

#if LIBDIVIDE_HAS_CONSTEXPR!=0

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_u16_t libdivide_internal_u16_gen_c(
    uint16_t d, bool branchfree) {
    if (d == 0) {
        LIBDIVIDE_ERROR("divider must be != 0");
    }

    uint8_t floor_log_2_d = libdivide_internal_u16_floor_log_2_d(libdivide_count_leading_zeros16_software(d));
    struct libdivide_32_div_16_result_t null_proposed_m = { 0U, 0U };
    struct libdivide_32_div_16_result_t proposed_m = libdivide_internal_u16_ispow2(d) ? null_proposed_m : libdivide_32_div_16_to_16((uint16_t)1 << floor_log_2_d, 0, d);
    return libdivide_internal_u16_gen_gen(d, branchfree, floor_log_2_d, proposed_m);
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_u16_t libdivide_u16_gen_c(uint16_t d) {
    return libdivide_internal_u16_gen_c(d, false);
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_u16_branchfree_t libdivide_u16_branchfree_gen_c(uint16_t d) {
    struct libdivide_u16_t tmp = libdivide_internal_u16_gen_c(d, true);
    return libdivide_internal_construct_u16_branchfree(tmp.magic, (uint8_t)(tmp.more & LIBDIVIDE_32_SHIFT_MASK));
}
...
static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s16_t libdivide_internal_s16_gen_gen(
    int16_t d, int branchfree, uint8_t floor_log_2_d, struct libdivide_32_div_16_result_t proposed_m) {
    ...
    // and is a power of 2.
    uint16_t absD = libdivide_internal_s16_abs(d);

    // check if exactly one bit is set,
    // don't care if absD is 0 since that's divide by zero
    if (libdivide_internal_u16_ispow2(absD)) {
        // Branchfree and normal paths are exactly the same
        return libdivide_internal_construct_s16(0U, (uint8_t)(floor_log_2_d | (d < 0 ? LIBDIVIDE_NEGATIVE_DIVISOR : 0)));
    } else {
        ...
        return libdivide_internal_construct_s16(magic, more);
    }
}
static LIBDIVIDE_INLINE struct libdivide_s16_t libdivide_internal_s16_gen(
    ...
    uint16_t absD = libdivide_internal_s16_abs(d);
    uint8_t floor_log_2_d = libdivide_internal_u16_floor_log_2_d(libdivide_count_leading_zeros16(absD));
    struct libdivide_32_div_16_result_t null_proposed_m = { 0U, 0U };
    struct libdivide_32_div_16_result_t proposed_m = libdivide_internal_u16_ispow2(absD) ? null_proposed_m : libdivide_32_div_16_to_16((uint16_t)1 << (floor_log_2_d - 1), 0, absD);;
    return libdivide_internal_s16_gen_gen(d, branchfree, floor_log_2_d, proposed_m);
}

struct libdivide_s16_t libdivide_s16_gen(int16_t d) {
    return libdivide_internal_s16_gen(d, false);
}

struct libdivide_s16_branchfree_t libdivide_s16_branchfree_gen(int16_t d) {
    struct libdivide_s16_t tmp = libdivide_internal_s16_gen(d, true);
    return libdivide_internal_construct_s16_branchfree(tmp.magic, tmp.more);
}

#if LIBDIVIDE_HAS_CONSTEXPR!=0

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s16_t libdivide_internal_s16_gen_c(
    int16_t d, bool branchfree) {
    if (d == 0) {
        LIBDIVIDE_ERROR("divider must be != 0");
    }

    uint16_t absD = libdivide_internal_s16_abs(d);
    uint8_t floor_log_2_d = libdivide_internal_u16_floor_log_2_d(libdivide_count_leading_zeros16_software(absD));
    struct libdivide_32_div_16_result_t null_proposed_m = { 0U, 0U };
    struct libdivide_32_div_16_result_t proposed_m = libdivide_internal_u16_ispow2(absD) ? null_proposed_m : libdivide_32_div_16_to_16((uint16_t)1 << (floor_log_2_d - 1), 0, absD);
    return libdivide_internal_s16_gen_gen(d, branchfree, floor_log_2_d, proposed_m);
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s16_t libdivide_s16_gen_c(int16_t d) {
    return libdivide_internal_s16_gen_c(d, false);
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s16_branchfree_t libdivide_s16_branchfree_gen_c(int16_t d) {
    struct libdivide_s16_t tmp = libdivide_internal_s16_gen_c(d, true);
    return libdivide_internal_construct_s16_branchfree(tmp.magic, tmp.more);
}
...
static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s64_t libdivide_internal_s64_gen_gen(
    ...
    // check if exactly one bit is set,
    // don't care if absD is 0 since that's divide by zero
    if (libdivide_internal_u64_ispow2(absD)) {
        // Branchfree and non-branchfree cases are the same
        return libdivide_internal_construct_s64(0, (uint8_t)(floor_log_2_d | (d < 0 ? LIBDIVIDE_NEGATIVE_DIVISOR : 0)));
    } else {
        ...
        return libdivide_internal_construct_s64(magic, more);
    }
}

static LIBDIVIDE_INLINE struct libdivide_s64_t libdivide_internal_s64_gen(int64_t d, bool branchfree) {
    if (d == 0) {
        LIBDIVIDE_ERROR("divider must be != 0");
    }
...
struct libdivide_s64_branchfree_t libdivide_s64_branchfree_gen(int64_t d) {
    struct libdivide_s64_t tmp = libdivide_internal_s64_gen(d, true);
    return libdivide_internal_construct_s64_branchfree(tmp.magic, tmp.more);
}

#if LIBDIVIDE_HAS_CONSTEXPR!=0

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s64_t libdivide_internal_s64_gen_c(
    uint64_t d, bool branchfree) {
    if (d == 0) {
        LIBDIVIDE_ERROR("divider must be != 0");
    }
...
static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s64_t libdivide_s64_gen_c(int64_t d) {
    return libdivide_internal_s64_gen_c(d, false);
}

static LIBDIVIDE_CONSTEXPR LIBDIVIDE_INLINE struct libdivide_s64_branchfree_t libdivide_s64_branchfree_gen_c(int64_t d) {
    struct libdivide_s64_t tmp = libdivide_internal_s64_gen_c(d, true);
    return libdivide_internal_construct_s64_branchfree(tmp.magic, tmp.more);
}
